...
export const MENU_DATA: MenuItem[] = [
  ...
  },
  {
    ...
    volume: '350ml',
    temperature: 'Cold',
    description: 'A classic refreshing drink made with double shots of espresso and chilled water over ice.',
    ingredients: [
      { name: 'ESPRESSO', color: '#3d2b1f' },
      { name: 'WATER', color: '#e0f7fa' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'CARAMEL DRIZZLE', color: '#c68e17' },
      { name: 'ESPRESSO', color: '#3d2b1f' },
      { name: 'STEAMED MILK', color: '#ffffff' },
      { name: 'VANILLA SYRUP', color: '#f3e5ab' },
    ],
